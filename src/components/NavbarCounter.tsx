...
export function NavbarCounter() {
  ...
  // Solo se muestra si el componente ya cargó en el cliente Y hay productos en el carrito
  ...
  return (
    <Link href="/cart" className="relative p-2 flex items-center justify-center hover:text-gray-500 transition-colors">
      {/* Removido el borde rojo de prueba */}
      ...
      {/* Burbuja Roja: Oculta por defecto si el carrito está vacío */}
      {showCount && (
